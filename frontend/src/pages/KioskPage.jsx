...
//       if(data.success) {
//         alert("Hardware Refilled Successfully!");
//         setShowAdmin(false);
//         setAdminPass("");
//         setStatus("idle"); // Jam khol diya
//         setShowSlides(true);
//       } else {
...
//           copies: data.copies,
//           mode: data.mode,
//           isTwoSided: data.is_two_sided,
//           printRange: data.print_range,
...
//         setErrorMessage("⚠️ Machine Problem Detected. Operator has been notified. Please wait until fixed, then try your OTP again.");
//         setStatus("error");
//       } else {
...
//   return (
//     // ✨ THEME & LAYOUT FIX: vh-100 & overflow-hidden taaki screen par perfect fit ho aur scroll na ho
...
//               {status === "printing" && (
//                 <div className="p-4 rounded-4 bg-white shadow-sm" style={{ color: '#0ea5e9' }}>
//                   <Printer size={60} className="mb-3 mx-auto d-block" />
...
//               {/* 🚨 JAMMED SCREEN (Hardware Lock) */}
//               {status === "jammed" && (
//                 <div className="bg-warning bg-opacity-10 p-4 p-md-5 rounded-4 border border-warning shadow-lg mx-auto text-center" style={{ maxWidth: '650px' }}>
