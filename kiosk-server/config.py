...
class Settings(BaseSettings):
    ...
    # Printer Config (cross-platform)
    PRINTER_IP: str = os.getenv("PRINTER_IP", "")
    
    # Windows-specific printer names (ignored on macOS/Linux)
    PRINTER_BW: str = os.getenv("PRINTER_BW", "Default Printer")
    PRINTER_BW_DUPLEX: str = os.getenv("PRINTER_BW_DUPLEX", "Default Printer")
    PRINTER_COLOR: str = os.getenv("PRINTER_COLOR", "Default Printer")
    PRINTER_COLOR_DUPLEX: str = os.getenv("PRINTER_COLOR_DUPLEX", "Default Printer")
    
    # macOS/Linux printer name (optional, uses default if not set)
    PRINTER_NAME: Optional[str] = os.getenv("PRINTER_NAME", None)
    ...
    # Windows-specific (ignored on other platforms)
    SUMATRA_PDF_PATH: str = os.getenv("SUMATRA_PDF_PATH", "")
